...
public class DescuentoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Descuento> updateDescuento(@PathVariable Long id, @RequestBody DescuentoRequest request) {
        return descuentoService.updateDescuento(id, request)
